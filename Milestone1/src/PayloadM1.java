	...
	public class PayloadM1 implements Serializable{
		/**
		 * 
		 */
		...
		private PayloadTypeM1 payloadType;
		public void setPayloadType(PayloadTypeM1 pt) {
			this.payloadType = pt;
		}
		public PayloadTypeM1 getPayloadType() {
