	...
	public class Client_M3 {
		...
		private UI_M3 listener;
		public void registerListener(UI_M3 window) {
		...
		public void setUsername(String name) {
			Payload_M3 p = new Payload_M3();
			p.setPayloadType(PayloadType_M3.CONNECT);
			p.setUsername(name);
			toServer.add(p);
		}
		...
		public void doClick(boolean isOn) {
			Payload_M3 payload = new Payload_M3();
			payload.setPayloadType(PayloadType_M3.SWITCH);
			payload.IsOn(isOn);
			toServer.add(payload);
		}
		...
		public static void main(String[] args) {
			Client_M3 client = new Client_M3();
			Client_M3.connect("127.0.0.1", 3001);
			try {
