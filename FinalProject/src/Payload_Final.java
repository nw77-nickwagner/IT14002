	...
	public class Payload_Final implements Serializable{
		/**
		 * 
		 */
		...
		private PayloadType_Final payloadType;
		public void setPayloadType(PayloadType_Final pt) {
			this.payloadType = pt;
		}
		public PayloadType_Final getPayloadType() {
